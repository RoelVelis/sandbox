...
export class Ship extends ex.Actor {
    ...
    private controls: { up: ex.Input.Keys, down: ex.Input.Keys, left: ex.Input.Keys, right: ex.Input.Keys, fire: ex.Input.Keys };

    constructor(x: number, y: number, width: number, height: number, controls: { up: ex.Input.Keys, down: ex.Input.Keys, left: ex.Input.Keys, right: ex.Input.Keys, fire: ex.Input.Keys }) {
        super({
